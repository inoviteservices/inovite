...
class Bringer_Before_After {
  constructor($obj = null) {
    ...
    this.$el = {
      $wrap: $obj,
      $before: jQuery(
        '<div class="bringer-before-after-img bringer-before-img"/>'
      ).appendTo($obj),
      $after: jQuery(
        '<div class="bringer-before-after-img bringer-after-img-wrap"/>'
      ).appendTo($obj),
      $divider: jQuery(
...
class Bringer_Menu {
  constructor(_core = null) {
    ...
    this.core.$dom.header.append(
      '<span class="bringer-active-menu-ind"></span>'
    );
...
class Bringer_Mobile_Menu {
  constructor($obj) {
    ...
    this.$nav = jQuery('<nav class="bringer-mobile-nav"/>').appendTo(
      this.$body
    );
    if (this.$el.parents("header").hasClass("is-frosted")) {
      this.$nav.addClass("is-frosted");
    }
    this.$menu = jQuery('<ul class="bringer-mobile-menu"/>').appendTo(
      this.$nav
    );
    this.$el
      .children("ul")
    ...
    this.$overlay = jQuery(
      '<div class="bringer-mobile-menu-overlay"/>'
    ).appendTo(this.$body);
...
class Bringer_Infinite_List {
    ...
    this.$el
      .on("mouseenter", ".bringer-infinite-list-item", function () {
        ...
        if ("video" === $preview.attr("data-type")) {
          jQuery(this)
            .children(".bringer-infinite-list-preview")
            .children("video")[0]
            .play();
  ...
  init() {
    ...
    this.$bg_wrap = jQuery('<div class="bringer-infinite-list-bgs"/>').appendTo(
      this.$el
    );
    this.$scroll = jQuery('<div class="bringer-infinite-scroll"/>').appendTo(
      this.$el
    );
    this.$cloned_list = jQuery(
      '<div class="bringer-infinite-scroll-inner"/>'
      ...
      if (_self.first_circle) {
        ...
        if ("video" === type) {
          ...
          _self.$bg_wrap.append(`
                    <div class="bringerl-bg-preview-item${
                      i === 0 ? " is-active" : ""
                    }" data-type="video" data-id="${i}" style="background-image:url(${this_src})">
          ...
          _self.$bg_wrap.append(
            `<div class="bringerl-bg-preview-item${
              i === 0 ? " is-active" : ""
            }" data-type="image" data-id="${i}" style="background-image:url(${this_src})"/>`
          );
        }
      }
    });
...
class Bringer_LWP {
  constructor($obj = null) {
    ...
    this.$media = jQuery(
      '<div class="bringer-lwp-media" data-appear="fade-right"/>'
    ).prependTo(this.$el);
