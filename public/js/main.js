...
jQuery(function ($) {
      ...
      jQuery(".bringer-circle-path-link:not(.is-init)").each(function () {
        ...
        $this.append(`
                <svg xmlns="http://www.w3.org/2000/svg" xml:Land="en" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 ${size} ${size}">
                    ...
                    <text>
                        <textpath xlink:href="#textcircle" textLength="${parseFloat(
                          Math.PI * d
                        ).toFixed(2)}">
  ...
  function LinksEvents() {
    ...
    if (
      jQuery(".bringer-albums-listing").length &&
      window.localStorage.getItem("bringer_return_from") != false
    ) {
      jQuery(window).trigger(
        "bringer_set_album",
        window.localStorage.getItem("bringer_return_from")
      );
  ...
  function Toggles() {
    if (jQuery(".bringer-toggles-item:not(.is-init)").length) {
      jQuery(".bringer-toggles-item:not(.is-init)").each(function () {
        ...
        $this
          .children(".bringer-toggles-item--title")
          .append('<i class="bringer-icon bringer-icon-arrow-down"/>');
  ...
  function Layout() {
    ...
    core.$dom.nav
      .find(".bringer-menu-offset")
      .removeClass("bringer-menu-offset");
